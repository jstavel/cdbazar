...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'store_itemaction', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['store.Item'])),
        ))
        db.send_create_signal(u'store', ['ItemAction'])

        # Adding field 'Item.to_store'
        db.add_column(u'store_item', 'to_store',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 10, 8, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'HistoricalItem.to_store'
        db.add_column(u'store_historicalitem', 'to_store',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 10, 8, 0, 0), blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'store_itemaction')

        # Deleting field 'Item.to_store'
        db.delete_column(u'store_item', 'to_store')

        # Deleting field 'HistoricalItem.to_store'
        db.delete_column(u'store_historicalitem', 'to_store')
