...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.to_store'
        db.add_column(u'store_article', 'to_store',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 10, 10, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.to_store'
        db.delete_column(u'store_article', 'to_store')
