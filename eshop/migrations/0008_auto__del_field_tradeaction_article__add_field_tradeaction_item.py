...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TradeAction.article'
        db.delete_column(u'eshop_tradeaction', 'article_id')

        # Adding field 'TradeAction.item'
        db.add_column(u'eshop_tradeaction', 'item',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['store.Item'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'TradeAction.article'
        db.add_column(u'eshop_tradeaction', 'article',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['store.Article'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'TradeAction.item'
        db.delete_column(u'eshop_tradeaction', 'item_id')
