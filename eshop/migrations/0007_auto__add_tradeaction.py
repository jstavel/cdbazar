...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TradeAction'
        db.create_table(u'eshop_tradeaction', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('article', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['store.Article'], null=True, blank=True)),
            ('discount', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=10, decimal_places=2)),
        ))
        db.send_create_signal(u'eshop', ['TradeAction'])


    def backwards(self, orm):
        # Deleting model 'TradeAction'
        db.delete_table(u'eshop_tradeaction')
    ...
    models = {
        ...
        u'eshop.tradeaction': {
            ...
            'article': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['store.Article']", 'null': 'True', 'blank': 'True'}),
