...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Reservation.duemonths'
        db.add_column(u'eshop_reservation', 'duemonths',
                      self.gf('django.db.models.fields.IntegerField')(default=6),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Reservation.duemonths'
        db.delete_column(u'eshop_reservation', 'duemonths')
