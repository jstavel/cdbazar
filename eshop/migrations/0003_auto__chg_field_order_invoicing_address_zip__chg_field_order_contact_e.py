...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Order.invoicing_address_zip'
        db.alter_column(u'eshop_order', 'invoicing_address_zip', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'Order.contact_email'
        db.alter_column(u'eshop_order', 'contact_email', self.gf('django.db.models.fields.EmailField')(max_length=30))

        # Changing field 'Order.invoicing_name'
        db.alter_column(u'eshop_order', 'invoicing_name', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'Order.invoicing_address_city'
        db.alter_column(u'eshop_order', 'invoicing_address_city', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'Order.invoicing_address_street'
        db.alter_column(u'eshop_order', 'invoicing_address_street', self.gf('django.db.models.fields.CharField')(max_length=30))

    def backwards(self, orm):

        # Changing field 'Order.invoicing_address_zip'
        db.alter_column(u'eshop_order', 'invoicing_address_zip', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'Order.contact_email'
        db.alter_column(u'eshop_order', 'contact_email', self.gf('django.db.models.fields.EmailField')(max_length=30, null=True))

        # Changing field 'Order.invoicing_name'
        db.alter_column(u'eshop_order', 'invoicing_name', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'Order.invoicing_address_city'
        db.alter_column(u'eshop_order', 'invoicing_address_city', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'Order.invoicing_address_street'
        db.alter_column(u'eshop_order', 'invoicing_address_street', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))
