...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Reservation.phone'
        db.delete_column(u'eshop_reservation', 'phone')
    ...
    def backwards(self, orm):
        # Adding field 'Reservation.phone'
        db.add_column(u'eshop_reservation', 'phone',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'eshop.reservation': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'query': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'})
        },
        u'eshop.tradeaction': {
