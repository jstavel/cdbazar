...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserDiscount'
        db.create_table(u'eshop_userdiscount', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('discount', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=10, decimal_places=2)),
        ))
        db.send_create_signal(u'eshop', ['UserDiscount'])

        # Deleting field 'Reservation.contact'
        db.delete_column(u'eshop_reservation', 'contact')

        # Adding field 'Reservation.email'
        db.add_column(u'eshop_reservation', 'email',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64),
                      keep_default=False)


        # Changing field 'Reservation.query'
        db.alter_column(u'eshop_reservation', 'query', self.gf('django.db.models.fields.CharField')(default='', max_length=64))

    def backwards(self, orm):
        # Deleting model 'UserDiscount'
        db.delete_table(u'eshop_userdiscount')

        # Adding field 'Reservation.contact'
        db.add_column(u'eshop_reservation', 'contact',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Reservation.email'
        db.delete_column(u'eshop_reservation', 'email')


        # Changing field 'Reservation.query'
        db.alter_column(u'eshop_reservation', 'query', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))
    ...
    models = {
        ...
        u'eshop.content': {
            ...
            'contentType': ('django.db.models.fields.CharField', [], {'max_length': '12'}),
        ...
        u'eshop.order': {
            ...
            'contact_phonenumber': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            ...
            'state': ('django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'max_length': '36', 'blank': 'True'})
        },
        u'eshop.orderadditionalitem': {
            'Meta': {'object_name': 'OrderAdditionalItem'},
        ...
        u'eshop.reservation': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'duemonths': ('django.db.models.fields.IntegerField', [], {'default': '6'}),
            'email': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'query': ('django.db.models.fields.CharField', [], {'max_length': '64'})
        },
        u'eshop.tradeaction': {
        ...
        u'eshop.userdiscount': {
            'Meta': {'object_name': 'UserDiscount'},
            'discount': ('django.db.models.fields.DecimalField', [], {'default': "'0'", 'max_digits': '10', 'decimal_places': '2'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
