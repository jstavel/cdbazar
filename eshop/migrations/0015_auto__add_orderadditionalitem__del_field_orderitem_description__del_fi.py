...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OrderAdditionalItem'
        db.create_table(u'eshop_orderadditionalitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eshop.Order'])),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
            ('meta', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
            ('price', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=10, decimal_places=2)),
        ))
        db.send_create_signal(u'eshop', ['OrderAdditionalItem'])

        # Deleting field 'OrderItem.description'
        db.delete_column(u'eshop_orderitem', 'description')

        # Deleting field 'OrderItem.price'
        db.delete_column(u'eshop_orderitem', 'price')

        # Deleting field 'OrderItem.meta'
        db.delete_column(u'eshop_orderitem', 'meta')

        # Adding field 'OrderItem.item'
        db.add_column(u'eshop_orderitem', 'item',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['store.Item']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'OrderAdditionalItem'
        db.delete_table(u'eshop_orderadditionalitem')

        # Adding field 'OrderItem.description'
        db.add_column(u'eshop_orderitem', 'description',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)

        # Adding field 'OrderItem.price'
        db.add_column(u'eshop_orderitem', 'price',
                      self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=10, decimal_places=2),
                      keep_default=False)

        # Adding field 'OrderItem.meta'
        db.add_column(u'eshop_orderitem', 'meta',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'OrderItem.item'
        db.delete_column(u'eshop_orderitem', 'item_id')
