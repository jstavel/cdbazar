...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DeliveryPrice'
        db.create_table(u'eshop_deliveryprice', (
        ...
        db.send_create_signal(u'eshop', ['DeliveryPrice'])
    ...
    def backwards(self, orm):
        # Deleting model 'DeliveryPrice'
        db.delete_table(u'eshop_deliveryprice')
