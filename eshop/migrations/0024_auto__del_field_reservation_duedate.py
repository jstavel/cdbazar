...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Reservation.duedate'
        db.delete_column(u'eshop_reservation', 'duedate')


    def backwards(self, orm):
        # Adding field 'Reservation.duedate'
        db.add_column(u'eshop_reservation', 'duedate',
