...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'eshop_order', 'state', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Order.state'
        db.alter_column(u'eshop_order', 'state', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
