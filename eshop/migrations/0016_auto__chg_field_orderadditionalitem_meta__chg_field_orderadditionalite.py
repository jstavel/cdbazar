...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OrderAdditionalItem.meta'
        db.alter_column(u'eshop_orderadditionalitem', 'meta', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

        # Changing field 'OrderAdditionalItem.description'
        db.alter_column(u'eshop_orderadditionalitem', 'description', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

    def backwards(self, orm):

        # Changing field 'OrderAdditionalItem.meta'
        db.alter_column(u'eshop_orderadditionalitem', 'meta', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'OrderAdditionalItem.description'
        db.alter_column(u'eshop_orderadditionalitem', 'description', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))
