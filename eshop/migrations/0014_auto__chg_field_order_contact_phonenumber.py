...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Order.contact_phonenumber'
        db.alter_column(u'eshop_order', 'contact_phonenumber', self.gf('django.db.models.fields.CharField')(default='', max_length=30))

    def backwards(self, orm):

        # Changing field 'Order.contact_phonenumber'
        db.alter_column(u'eshop_order', 'contact_phonenumber', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))
